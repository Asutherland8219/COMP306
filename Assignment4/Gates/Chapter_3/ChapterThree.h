...
public:
    ...
    static bool duchessIntroChoice(int duchess_intro, Character custom_character);
    static bool duchessHouseChoice(int duchess_house, Character custom_character);
};
