    ...
    void startAliceInWonderland(Character custom_character) {
        ...
        while (!Intro::well_breaker){
            ...
            if (std::cin.fail()) {
                ...
                well_breaker = wellChoice(choice);
            }
        }
        ...
        std::cout << "You start to get more comfortable in this seemingly suspended time. You close your eyes and then THUMP...\n";
        ...
        while (!Intro::land_breaker) {
            ...
            if (std::cin.fail()) {
                ...
                land_breaker = landChoice(land_choice);
            }
        }
        ...
        while (!Intro::hall_breaker) {
            ...
            hall_breaker = hallwayChoice(hallway_choice);
        }
        ...
        while (!Intro::drink_breaker) {
            ...
            drink_breaker = drinkChoice(drink_choice);
        ...
        while (!Intro::table_breaker) {
            ...
            table_breaker = tableChoice(table_choice);
